...
namespace HotelBookingPlatform.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCreated : INotificationHandler<TodoItemCreatedEvent>
{
    ...
    {
        _logger.LogInformation("HotelBookingPlatform Domain Event: {DomainEvent}", notification.GetType().Name);
